//
//  SecondMenuContainerViewController.swift
//  testdemo
//
//  Created by 常仲伟 on 2021/4/21.
...
class SecondMenuContainerViewController: UIViewController {
...
extension SecondMenuContainerViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
    UIScreen.main.bounds.height - self.tableView(tableView, heightForHeaderInSection: indexPath.section)
  }
...
extension SecondMenuContainerViewController: PagingMenuViewControllerDataSource {
...
extension SecondMenuContainerViewController: PagingContentViewControllerDataSource {
...
extension SecondMenuContainerViewController: PagingMenuViewControllerDelegate {
  func menuViewController(viewController: PagingMenuViewController, didSelect page: Int, previousPage: Int) {
    contentViewController.scroll(to: page, animated: true)
  }
}

extension SecondMenuContainerViewController: PagingContentViewControllerDelegate {
