...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FRDIntent/FRDIntent.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LiteRoute/LiteRoute.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RouterService/RouterService.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RouterServiceInterface/RouterServiceInterface.framework"
